...
export default function RegisterPage() {
  ...
  const validateForm = () => {
    ...
    if (!passwordRegex.test(formData.password)) {
      newErrors.password = 'Password must be at least 6 characters with at least 1 number and 1 special character.';
    }
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-3xl shadow-xl border border-teal-100">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-xs sm:text-sm text-slate-500">
            Join MediCare Connect for instant hospital appointments and secure health records.
          </p>
        </div>
        ...
        <p className="text-center text-xs sm:text-sm text-slate-500">
          ...
          <Link href="/login" className="font-bold text-teal-700 hover:text-teal-800 underline">
            Log in here
          </Link>
        </p>
      </div>
