...
export default function Footer() {
  return (
    <footer className="bg-slate-900 text-slate-300 border-t border-slate-800">
      ...
      <div className="bg-gradient-to-r from-red-600 to-rose-700 text-white py-4 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs uppercase tracking-wider font-semibold text-red-100">
                24/7 Medical Emergency Hotline
              </p>
              <p className="text-xl font-extrabold tracking-tight">
                Call +1 (800) 456-7890 / 911
              </p>
            </div>
          </div>
          <p className="text-xs text-red-100 max-w-md">
            Immediate dispatch assistance and triage support available 24 hours a day, 7 days a week.
          </p>
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-white text-red-700 hover:bg-red-50 px-4 py-2 rounded-xl text-xs font-bold transition-all shadow-md"
          >
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link href="/dashboard" className="hover:text-teal-400 transition-colors flex items-center gap-2">
                  <ArrowRight className="w-3.5 h-3.5 text-teal-500" /> Patient Portal
                </Link>
              </li>
            </ul>
          </div>
